/* By default, Android build system defines some of the constants defined
   below. To avoid warnings, start from a clean state by undefining them */
...
/* No sigsetjmp in bionic for x86 */
#else
...
#define RECVFROM_TYPE_ARG5 const struct sockaddr
